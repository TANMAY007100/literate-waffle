...
# Flag Field
# This is just to be able to see the flag, as the top part of flag is white
# Note: There is no black border around the original flag.
...
flag_field.seth(0)
flag_field.pendown()
flag_field.color(BLACK_COLOR, WHITE_COLOR)
...
next_pos_x, next_pos_y = make_band(band_turtle, GREEN_COLOR, left_top_x, left_top_y - band_height, flag_width, band_height)
