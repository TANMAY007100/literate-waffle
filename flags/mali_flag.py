...
x_pos, y_pos = draw_vertical_band(flag, flag_height, band_width, x_pos, y_pos, GOLD_COLOR)
x_pos, y_pos = draw_vertical_band(flag, flag_height, band_width, x_pos, y_pos, RED_COLOR)
