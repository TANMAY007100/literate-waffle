...
flag = te.Turtle()
x_pos, y_pos = draw_vertical_band(flag, flag_height, band_width, left_top_x, left_top_y, BLUE_COLOR)
x_pos, y_pos = draw_vertical_band(flag, flag_height, band_width, x_pos + band_width, y_pos, YELLOW_COLOR)
x_pos, y_pos = draw_vertical_band(flag, flag_height, band_width, x_pos + band_width, y_pos, RED_COLOR)
